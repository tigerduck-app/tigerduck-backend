// Notification list pages. Both components are route targets, so they
// stay here; the member picker and shared helpers are in ./lists/.
...
import type { DeviceList, DeviceListMembersResponse } from "@/types/api";
import { AddMembersPanel } from "./lists/AddMembersPanel";
import { asMessage, formatTs } from "./lists/format";
